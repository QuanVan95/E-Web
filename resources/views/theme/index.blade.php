...
@section('pageTitle', 'technology innovation agency')
@section('content')
    ...
    <div itemscope itemtype="http://schema.org/Article" id="primary-wrapper"
                            ...
                            <article id="post-6" class="post-6 page type-page status-publish hentry">
                                <section class="entry">
                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1456658216460 custom_height full_row_height vc_row-flex vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_rotate-left-to-right rotate-left-to-right">
                                                        <div class="wpb_wrapper">
                                                            <h1 style="text-align: left;"><span
                                                                        class="xlarge-text text_linkcolor">{{$homeData[0]->title}}</span>
                                                            </h1>
                                                        ...
                                                        <div class="acoda-writer-inner">
                                                            <h1 class="format -weight" style="color:#ff918f;">
                                                                <span class="acoda-writer " data-type="" data-duration="3000" data-delay="100" data-pause="5000">&nbsp;
                                                                    @foreach($homeData[0]->animation_title as $value)
                                                                        <span class="element">
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_rotate-left-to-right rotate-left-to-right">
                                                        <div class="wpb_wrapper">
                                                            <h2 style="text-align: left;"><span class="big-text">{{$homeData[0]->sub_title}}
                                                                    <span class="text_linkcolor"></span></span></h2>
                                                    ...
                                                    <div class="vc_btn3-container  wpb_animate_when_almost_visible wpb_left-to-right left-to-right vc_btn3-right">
                                                        <a class="vc_general vc_btn3 vc_btn3-size-xlg vc_btn3-shape-square vc_btn3-style-flat vc_btn3-icon-right vc_btn3-color-link_color"
                                                           href="{{ route('our_vision.show') }}" title="">SEE OUR VISION
                                                            <i
        ...
        <link rel='stylesheet' id='acoda-skin-css' href='{{asset('css/ca781558a3151731055b49fe0f1e13fe.css')}}'
              type='text/css' media='all'/>
        <style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1456658216460 {
                padding-bottom: 200px !important;
                background-image: url('{{asset('images/background_images/'. $configs[0]['background_image']) }}') !important;
        ...
        <link rel='stylesheet' id='animate-css-css' href='{{asset('css/animate.min3c21.css?ver=5.1.1')}}' media='all'/>
        <script type='text/javascript' src='{{asset('js/post-like.min5152.js?ver=1.0')}}'
        ></script>
        <script type='text/javascript' src='{{asset('js/d9cc8f6a8cd554fb7df651a16b962270.js')}}'
        ></script>
        ...
        <script type='text/javascript'
                src='{{asset('js/row-shapes.min2af5.js?ver%5B0%5D=jquery&amp;ver%5B1%5D=acoda-script')}}'></script>
