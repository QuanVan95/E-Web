...
@section('content')
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1474873232771 {
            padding-top: 140px !important;
            padding-bottom: 140px !important;
        }

        .vc_custom_1474873294587 {
            padding-top: 140px !important;
        ...
        .vc_custom_1474873388543 {
            padding-top: 140px !important;
            padding-bottom: 200px !important;
            background-color: #ff918f !important;
        }

        .vc_custom_1474873415697 {
            padding-top: 140px !important;
            padding-bottom: 200px !important;
        }

        .vc_custom_1474873441719 {
            padding-top: 140px !important;
            padding-bottom: 200px !important;
            background-color: #ff908d !important;
        }

        .vc_custom_1474872982121 {
            padding-top: 140px !important;
            padding-bottom: 140px !important;
        }

        .vc_custom_1456648930850 {
            padding-bottom: 15px !important;
        }

        .vc_custom_1456648921276 {
            padding-bottom: 15px !important;
        }

        .vc_custom_1456648909553 {
            padding-bottom: 15px !important;
        }</style>
            ...
            <div id="main-wrap" role="main">
                <div class="main-wrap skinset-main acoda-skin clearfix ">
                        ...
                        <div id="content" class="columns large-12 layout_one">
                            <article id="post-594" class="post-594 page type-page status-publish hentry">
                                <section class="entry">
                                    ...
                                    @foreach($postOurVision as $post)
                                        @if($post->position == 1 && $post->active == 1)
                                    <div class="vc_row wpb_row row vc_row-parent vc_custom_1474873232771 vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h1><span class="xlarge-text text_linkcolor">{{$post->title}}<br/>
</span></h1>
                                                        ...
                                                        <div class="acoda-writer-inner">
                                                            <h1 class="format -weight" style="color:#ff918f;">
                                                                <span class="acoda-writer " data-type="" data-duration="3000" data-delay="100" data-pause="5000">&nbsp;
                                                                    @foreach(($post->animation_title) as $value)
                                                                        <span class="element">
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_rotate-top-to-bottom rotate-top-to-bottom">
                                                        <div class="wpb_wrapper">
                                    ...
                                    <div data-vc-full-width="true" data-vc-full-width-init="false" style="color:#ffffff;"
                                         data-anchor-link="process"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873294587 custom-row link_anchor anchor-process vc_row-o-content-middle">
                                        ...
                                        <div class="overlay-wrap" style="background-color:rgba(0,0,0,0.05)"></div>
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="row-shape-wrap top  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03e368d"
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03e368d)"></rect>
                                                        </svg>
                                                    </div>
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            @foreach($postOurVision as $post)
                                                                @if($post->position == 2 && $post->active == 1)
                                                            <h2><span class="xlarge-text">{{$postOurVision[1]->title}}</span></h2>
                                                                @endif
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="vc_row wpb_row vc_inner row vc_row-o-equal-height vc_row-o-content-middle vc_row-flex">
                                                        @foreach($postCategory->sub_categories as $key => $value)
                                                        <div class="wpb_column vc_column_container vc_col-sm-4">
                                                            <div class="vc_column-inner ">
                                                                <div class="wpb_wrapper">
                                                                    {{--<div class="vc_icon_element vc_icon_element-outer vc_custom_1456648930850 vc_icon_element-align-inline">--}}
                                                                        {{--<div class="vc_icon_element-inner vc_icon_element-color-link_color vc_icon_element-size-xl vc_icon_element-style- vc_icon_element-background-color-skin_element">--}}
                                                                    ...
                                                                    <div class="wpb_text_column wpb_content_element ">
                                                                        <div class="wpb_wrapper">
                                                                            @if($value->active == 1)
                                                                            <h3><span class="big-text"><span
                                                                                            class="text_linkcolor">{{$key+1}}.</span> <span
                                                                                            class="white-text"><a href="#{{ $value->key }}">{{$value->name}}</a></span></span>
                                                                            </h3>
                                                                            @endif
                                                    ...
                                                    <div class="row-shape-wrap bottom  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03e5d4f"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#ff918f" points="0,100 100,100 100,0  "/>
                                                                </pattern>
                                                            </defs>
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03e5d4f)"></rect>
                                                        </svg>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div data-vc-full-width="true" data-vc-full-width-init="false" style="color:#ffffff;"
                                         data-anchor-link="think"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873388543 link_anchor anchor-think vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2><span class="large-text">{{$key+1}}. {{$value->name}}</span></h2>
                                                            <p>{{ $value->description }}</p>

                                                        </div>
                                                    </div>
                                                    @foreach($value->posts as $items)
                                                    ...
                                                    <div class="row-shape-wrap bottom  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03e8e76"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#ffffff" points="100,100 0,100 0,0 "/>
                                                                </pattern>
                                                            </defs>
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03e8e76)"></rect>
                                                        </svg>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if($value->key == 'plan')
                                        @if($value->active == 1)
                                    <div class="vc_row-full-width"></div>
                                    <div data-vc-full-width="true" data-vc-full-width-init="false" data-anchor-link="plan"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873415697 link_anchor anchor-plan vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="row-shape-wrap bottom  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03e9cb8"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#ff918f" points="0,100 100,100 100,0  "/>
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03e9cb8)"></rect>
                                                        </svg>
                                                    </div>
                                                    <div class="vc_row wpb_row vc_inner row">
                                                        <div class="wpb_column vc_column_container vc_col-sm-6">
                                                            <div class="vc_column-inner ">
                                                                <div class="wpb_wrapper">
                                                                    <div class="wpb_text_column wpb_content_element ">
                                                                        <div class="wpb_wrapper">
                                                                            <h2><span class="large-text">{{$key+1}}. {{$value->name}}</span>
                                                                            </h2>
                                                                            <p>{{ $value->description }}</p>
                                                        ...
                                                        <div class="wpb_column vc_column_container vc_col-sm-6">
                                                            <div class="vc_column-inner ">
                                                                <div class="wpb_wrapper">
                                                                    ...
                                                                    <div class="wpb_text_column wpb_content_element ">
                                                                        <div class="wpb_wrapper">
                                                                            <h3>{{ $value->posts['title'] }}</h3>
                                                                            <p>{{ $value->posts['sub_title'] }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="vc_row-full-width"></div>
                                    <div data-vc-full-width="true" data-vc-full-width-init="false" style="color:#ffffff;"
                                         data-anchor-link="create"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873441719 link_anchor anchor-create vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="vc_row wpb_row vc_inner row">
                                                    ...
                                                    <div class="row-shape-wrap bottom  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03ec61a"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#ffffff" points="100,100 0,100 0,0 "/>
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03ec61a)"></rect>
                                                        </svg>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div data-vc-full-width="true" data-vc-full-width-init="false" data-anchor-link="thewhy"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474872982121 link_anchor anchor-thewhy vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    @foreach($postOurVision as $post)
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2 style="text-align: left;"><span
                                                                        class="text_linkcolor xlarge-text">{{$post->title}}</span>
                                                            </h2>
                                                            <h3><span class="xlarge-text">{{$post->sub_title}}<span
                                                                            class="text_linkcolor"></span></span></h3>
                                                            <p>{{$post->content}}</p>
                                                    ...
                                                    <div class="vc_empty_space" style="height: 60px"><span
                                                                class="vc_empty_space_inner"></span></div>
                                                    <div class="vc_btn3-container  wpb_animate_when_almost_visible wpb_left-to-right left-to-right vc_btn3-right">
                                                        <a class="vc_general vc_btn3 vc_btn3-size-xlg vc_btn3-shape-square vc_btn3-style-flat vc_btn3-icon-right vc_btn3-color-link_color"
                                                           href="{{route('what_we_do.show')}}" title="">LEARN MORE ABOUT US <i
                    ...
                    <footer id="footer-wrap" class="skinset-footer acoda-skin">
                        ...
                        <!--<div class="lowfooterleft">&copy; 2017 You | Agency-->
                        <!--</div>-->
                        <!--<div class="lowfooterright"><a-->
                        <!--href="http://themeforest.net/item/you-multipurpose-responsive-wordpress-theme/15175900?ref=-ACODA-"-->
                        <!--title="You WordPress Theme" target="_blank">You WordPress Theme</a> | Created by-->
                        <!--<a href="http://acoda.com/">Acoda</a>-->
                        <!--</div>-->
                        <!--</div>&lt;!&ndash; / lowerfooter &ndash;&gt;-->
                        <!--</div>&lt;!&ndash; / row &ndash;&gt;-->
                        <!--</div>&lt;!&ndash; / lowerfooter-wrap &ndash;&gt;-->
    ...
    <link rel='stylesheet' id='animate-css-css'
          href='{{asset('css/animate.min3c21.css?ver=5.1.1')}}'
    ...
    <script type='text/javascript' src='{{asset('js/post-like.min5152.js?ver=1.0')}}'
            ></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
        var wpcf7 = {
