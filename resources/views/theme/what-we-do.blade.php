...
@section('content')
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1474873492615 {
            padding-top: 140px !important;
            padding-bottom: 140px !important;
        }

        .vc_custom_1474873748846 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
            background-color: #ff8f8b !important;
        }

        .vc_custom_1474873788762 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
        }

        .vc_custom_1474873814433 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
            background-color: #f4f4f4 !important;
        }

        .vc_custom_1456647639141 {
            padding-top: 150px !important;
            padding-bottom: 60px !important;
        }

        .vc_custom_1474873844082 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
            background-color: #ff8f8b !important;
        }

        .vc_custom_1474874016826 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
        }

        .vc_custom_1474873853775 {
            padding-top: 200px !important;
            padding-bottom: 140px !important;
            background-color: #f4f4f4 !important;
        }

        .vc_custom_1474873862066 {
            padding-top: 200px !important;
            padding-bottom: 200px !important;
        }

        .vc_custom_1448483405769 {
                            ...
                            <article id="post-7" class="post-7 page type-page status-publish hentry">
                                <section class="entry">
                                    ...
                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873492615 custom-row vc_row-o-content-middle">
                                            ...
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h1><span class="text_linkcolor xlarge-text">{{$post->title}}</span>
                                                            </h1>
                                    ...
                                    <div class="vc_row-full-width"></div>
                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873814433 vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="row-shape-wrap top  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03ef785"
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03ef785)"></rect>
                                                        </svg>
                                                    </div>
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2><span class="xlarge-text">{{$post->title}}</span></h2>
                                    ...
                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1456647639141 vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            ...
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="row-shape-wrap top static " style="height:120px">
                                                        <svg id="flexishape-5a137f03f06aa" x="0px" y="0px" fill="#f4f4f4"
                                                             viewBox="0 0 100 100" width="100px" height="120px"
                                                             preserveAspectRatio="none">
                                                            <polygon fill="#f4f4f4" points="100,0 50,100 0,0  "/>
                                                        </svg>
                                                    </div>
                                                    <div class="row-shape-wrap top  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f03f077e"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#f4f4f4" points="100,0 0,0 0,100 "/>
                                                                </pattern>
                                                            </defs>
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f03f077e)"></rect>
                                                        </svg>
                                                    </div>
                                                    <div id="group-slider-5a137f03f0996"
                                                         class="gallery-wrap group-slider shortcode loading  nav-arrowstatic acoda-skin clearfix"
                                                         data-groupslider-fx="scrollHorz" data-type="groupslider">
                                                        <div class="group-slider ">


                                                            {{-- Client Area 1--}}
                                                            @foreach($clientPost as $posts)
                                                            <div class="groupslides-wrap column_padding">
                                                                <div class="row groupslider-row">
                                                                    @foreach ($posts as $post)
                                                                    <div class="panel block columns large-4 "
                                                                         data-id="id-1">
                                                            ...
                                                            {{--<div class="groupslides-wrap column_padding">--}}
                                                                {{--<div class="row groupslider-row">--}}
                                                                    {{--@foreach($secondClientArray as $client)--}}
                                                                    {{--<div class="panel block columns large-4 "--}}
                                                                         {{--data-id="id-4">--}}
                                                                        {{--<div class="panel-inner">--}}
                                                                            {{--<div class="container   "--}}
                                                            ...
                                                            {{--@if(count($thirdClientArray)>0)--}}
                                                                {{--Client Area 3--}}
                                                                {{--<div class="groupslides-wrap column_padding">--}}
                                                                    {{--<div class="row groupslider-row">--}}
                                                                        {{--@foreach($thirdClientArray as $client)--}}
                                                                            {{--<div class="panel block columns large-4 "--}}
                                                                                 {{--data-id="id-4">--}}
                                                                                {{--<div class="panel-inner">--}}
                                                                                    {{--<div class="container   "--}}
                                                    ...
                                                    {{--End Client Area 3--}}
                                                        ...
                                                        <div class="slidernav-left">
                                                            <div class="slidernav"><a href="#"></a></div>
                                                        </div>
                                                        <div class="slidernav-right">
                                                            <div class="slidernav"><a href="#"></a></div>
                                                        </div>
                                                        <div class="dynamic-frame" data-offset="6" data-total="6"
                                                             data-load-value="3"><input
                                                                    name="group-slider-5a137f03f0996_timeout" class="timeout"
                                                                    value="3" type="hidden"/></div>
                                    ...
                                    {{--Post 4--}}
                                    @foreach($allPost as $post)
                                        @if($post->position == 4 && $post->active == 1)

                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873853775 vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="row-shape-wrap top  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f0405651"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#ffffff" points="0,0 100,0 100,100  "/>
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f0405651)"></rect>
                                                        </svg>
                                                    </div>
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2><span class="xlarge-text">{{$post->title}}<span
                                                                            class="text_linkcolor"></span></span></h2>
                                                            <h3>{{$post->sub_title}}<span class="text_linkcolor"></span></h3>
                                ...
                                {{--End Post 4--}}
                                    <div class="vc_row-full-width"></div>
                                    <div data-vc-full-width="true" data-vc-full-width-init="false"
                                         class="vc_row wpb_row row vc_row-parent vc_custom_1474873862066 vc_row-o-content-middle">
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="vc_btn3-container vc_btn3-center">
                                                        <a class="vc_general vc_btn3 vc_btn3-size-xlg vc_btn3-shape-square vc_btn3-style-flat vc_btn3-icon-right vc_btn3-color-link_color"
                                                           href="{{route('case_study.show')}}" title="">VIEW OUR CASE STUDIES
                                                            <i class="vc_btn3-icon fa fa-long-arrow-right"></i></a></div>

                                                    <div class="row-shape-wrap top static " style="height:120px">
                                                        <svg id="flexishape-5a137f04069f5" x="0px" y="0px" fill="#f4f4f4"
                                                             viewBox="0 0 100 100" width="100px" height="120px"
                                                             preserveAspectRatio="none">
                                                            <polygon fill="#f4f4f4" points="100,0 50,100 0,0  "/>
                                                        </svg>
                                                    ...
                                                    <div class="row-shape-wrap top  " style="height:80px">
                                                        <svg width="100%" height="80px">
                                                            <defs>
                                                                <pattern id="flexishape-5a137f0406adf"
                                                                         preserveAspectRatio="none"
                                                                         patternUnits="userSpaceOnUse" x="0" y="0"
                                                                         width="100%" height="800px" viewBox="0 0 100 1000">
                                                                    <polygon fill="#f4f4f4" points="100,0 0,0 0,100 "/>
                                                            ...
                                                            <rect x="0" y="0" width="100%" height="80px"
                                                                  fill="url(#flexishape-5a137f0406adf)"></rect>
                                                        </svg>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <link rel='stylesheet' id='animate-css-css' href='{{asset('css/animate.min3c21.css?ver=5.1.1')}}'
          type='text/css' media='all'/>
    <link rel='stylesheet' id='ihover-css' href='{{asset('css/ihover.min.css')}}' media='all'/>
    ...
    <script type='text/javascript'
            src='js/row-shapes.min2af5.js?ver%5B0%5D=jquery&amp;ver%5B1%5D=acoda-script'></script>
    <script type='text/javascript'
            src='js/waypoints.min3c21.js?ver=5.1.1'></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
    ...
    <script type='text/javascript'
            src='js/dc26ea19938ddd175c5a8873affc26a6-1.js'></script>
    <script type='text/javascript' src='{{asset('js/wp-embed.min33a6.js?ver=4.9')}}'></script>
    <script type='text/javascript'
            src='{{asset('js/js_composer_front.min3c21.js?ver=5.1.1')}}'></script>
    <script type='text/javascript'
            src='{{asset('js/skrollr.min3c21.js?ver=5.1.1')}}'
            ></script>
    <script type='text/javascript'
            src='{{asset('js/jquery.cycle.plugin.min0556.js?ver%5B0%5D=jquery')}}'></script>
    <script type='text/javascript'
            src='{{asset('js/touch.gestures.min0556.js?ver%5B0%5D=jquery')}}'
            ></script>
    <script type='text/javascript'
            src='{{asset('js/group.slider.min6ecb.js?ver%5B0%5D=jquery-cycle')}}'></script>
